...
{
    internal SurfacePattern(void* handle, bool owner) : base(handle, owner) { }
    ...
    public SurfacePattern(Surface surface)
        : base(cairo_pattern_create_for_surface(surface.Handle), owner: true) { }
    ...
    public Surface? Surface
    {
        get
        {
            ...
            return surfaceHandle is null ? null : new Surface(surfaceHandle, owner: false);
        }
    }
}
