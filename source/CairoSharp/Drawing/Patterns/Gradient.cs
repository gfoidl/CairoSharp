...
/// </summary>
public abstract unsafe class Gradient(cairo_pattern_t* pattern, bool isOwnedByCairo = false, bool needsDestroy = true)
    : Pattern(pattern, isOwnedByCairo, needsDestroy)
{
    /// <summary>
